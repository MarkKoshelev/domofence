...
public class MainActivity extends Activity {
  ...
  public void testServerConnection(View view) {
    ...
    Intent intent = new Intent(getApplicationContext(), DomoFenceBroadcastReceiver.class);
    intent.setAction("TestConnection");
    intent.putExtra("server_address", mServerAddress.getText().toString());
    intent.putExtra("server_port", optionalPort);
    intent.putExtra("username", mUsername.getText().toString());
    intent.putExtra("password", mPassword.getText().toString());
    intent.putExtra("switchIdx", mIdxOfSwitch.getText().toString());
    intent.putExtra("protocol", mSpinner.getSelectedItem().toString());
    intent.putExtra("state", state);

    Log.d(TAG, "Sending test intent");
